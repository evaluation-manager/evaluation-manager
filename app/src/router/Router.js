...
function  setar(){
    ...
    return (
        ...
        <Routes>
                ...
                <Route path='/Cadastro/Setor/Editar/:id' element={<EditarSetor/>}/>

             
                 <Route path='/Cadastro/Servico' element={<ServiceCad />} />
                 <Route path='/Cadastro/Servico/Editar/:id' element={<EditService/>}/>

                <Route path='/Cadastro/Servico_tipo' element={<ServiceTypeCad />} />
                <Route path='/Cadastro/Servico_tipo/Editar/:id' element={<EditarServiceType/>}/>
                               
                            
                <Route path='/Perguntas/Answers' element={<Respostas/>}/>               
                <Route path='/Perguntas/Answers/Editar/:id' element={<EditarAnswers/>}/>

                <Route path='/Perguntas/Themes' element={<CriarTheme/>}/>
                <Route path='/Perguntas/Themes/Editar/:id' element={<EditarTheme/>}/>
              

                <Route path='/Perguntas/Questions' element={<PerguntasGet/>}/>             
                <Route path='/Perguntas/Questions/Editar/:id' element={<EditarQuestins/>}/>
